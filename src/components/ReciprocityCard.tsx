...
const ReciprocityCard = ({ username, data }) => {
    return (
        <div className="bg-white dark:bg-slate-800 p-4 rounded-2xl shadow-lg border border-slate-200/80 dark:border-slate-700 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
            ...
            <div className="mb-3">
                <h4 className="font-semibold text-green-600 dark:text-green-400 mb-1">Starred By You:</h4>
            ...
            <div>
                <h4 className="font-semibold text-blue-600 dark:text-blue-400 mb-1">Starred Back:</h4>
